...
# Check behavior of known complexes

```{r}
interacting <- read.table("interacting_complexes.txt", sep='\t',
                          stringsAsFactors = FALSE, row.names = 1)
nonint <- read.table("non-interacting_proteins.txt", sep='\t',
                     stringsAsFactors = FALSE, row.names = 1)
...
# make one long data.frame/data.table 
...
# fraction normalization or spike-in (see help of normalize_values)
